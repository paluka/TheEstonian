...
module.exports = function theEstonian(string) {
  if (typeof string !== 'string') throw new TypeError('theEstonian only accepts a string.');
  console.log(string);
};
...
(0, _index.default)('THIS IS A TEST');
